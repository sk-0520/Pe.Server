...
function execute_install() {
	...
	apt --yes update
	apt --yes install php${PHP_VERSION} php${PHP_VERSION}-fpm php${PHP_VERSION}-sqlite3 php${PHP_VERSION}-mbstring php${PHP_VERSION}-zip php${PHP_VERSION}-xml php${PHP_VERSION}-gd php${PHP_VERSION}-xdebug
