...
describe("string", () => {
	...
	test("replaceAllImpl", () => {
		expect(string.replaceAllImpl("abcabcABCABC", "a", "-")).toBe(
			"-bc-bcABCABC",
		);
		expect(string.replaceAllImpl("abcabcABCABC", /a/, "-")).toBe(
			"-bc-bcABCABC",
		);
		expect(string.replaceAllImpl("abcabcABCABC", /a/i, "-")).toBe(
			"-bc-bc-BC-BC",
		);
		expect(string.replaceAllImpl("abcabcABCABC", /a/g, "-")).toBe(
			"-bc-bcABCABC",
		);
		expect(string.replaceAllImpl("abcabcABCABC", /a/gi, "-")).toBe(
			"-bc-bc-BC-BC",
		);
	});
