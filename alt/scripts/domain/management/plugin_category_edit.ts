...
function registerRow(trElement: HTMLTableRowElement) {
	...
	const updateElement = trElement.querySelector(
		'[name="update"]',
	) as HTMLButtonElement;
	const deleteElement = trElement.querySelector(
		'[name="delete"]',
	) as HTMLButtonElement;
	...
	updateElement.addEventListener(
		"click",
		async (ev) => {
			const displayNameElement = trElement.querySelector(
				'[name="display-name"]',
			) as HTMLInputElement;
			...
			const descriptionElement = trElement.querySelector(
				'[name="description"]',
			) as HTMLInputElement;
...
function registerAdd() {
	document
		...
		?.addEventListener("click", async (ev) => {
			...
			const categoryAddDisplayNameElement = document.getElementById(
				"category_add_display",
			) as HTMLInputElement;
			const categoryAddDescriptionElement = document.getElementById(
