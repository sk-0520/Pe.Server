		...
		parent::__construct(
			...
			[
				...
				(new RouteInformation('management', ManagementController::class, [AdministratorAccountFilterMiddleware::class]))
					...
					->addAction('database-maintenance/:database@\\w+', HttpMethod::Get, 'database_maintenance_get')
					->addAction('database-maintenance/:database@\\w+', HttpMethod::Post, 'database_maintenance_post', [CsrfMiddleware::class])
					->addAction('database-download/:database@\\w+', HttpMethod::Get, 'database_download_get')
