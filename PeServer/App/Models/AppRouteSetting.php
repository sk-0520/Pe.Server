		...
		parent::__construct(
			...
			[
				...
				(new RouteInformation('account', AccountController::class))
					...
					->addAction('user/api', HttpMethod::Post, 'user_api_post', [UserAccountFilterMiddleware::class, CsrfMiddleware::class])
				...
				(new RouteInformation('management', ManagementController::class, [AdministratorAccountFilterMiddleware::class]))
					...
					->addAction('mail-send', HttpMethod::Post, 'mail_send_post', [CsrfMiddleware::class])
